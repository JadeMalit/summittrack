...
const TrailData staCruzSibulanTrail = TrailData(
  ...
  description:
      'The Sta. Cruz / Sibulan Trail is a known southern route to Mt. Apo. It starts through farm and jungle trail, then progresses toward the Boulder Face before the final push to higher elevations. The route offers a mix of forest, volcanic terrain, and open mountain views for hikers who are ready for a more demanding climb.',
  slopeDifficulty:
