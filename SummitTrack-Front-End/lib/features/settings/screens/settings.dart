              ...
              children: [
                CircleAvatar(
                  ...
                  child: user?.photoURL == null
                      ? const Icon(Icons.person, color: _green, size: 34)
                      : null,
                ),
              ...
              _SettingsTile(
                ...
                onTap: () {
                  showAboutDialog(
                    ...
                    applicationIcon: const Icon(Icons.terrain, color: _green),
                  );
                },
              ),
            ],
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Container(
        ...
        child: Icon(icon, color: SettingsScreen._green),
      ),
      title: Text(
        title,
        style: const TextStyle(
      ...
      subtitle: Text(
        subtitle,
        style: const TextStyle(color: Color(0xFF687062), fontSize: 12.5),
      ),
      trailing: const Icon(Icons.chevron_right, color: Color(0xFF7A8374)),
    );
  }
}
