...
class MtLingguhobScreen extends StatelessWidget {
  const MtLingguhobScreen({super.key});
  ...
  static const _headerImage = 'assets/images/apo.jpg'; // Palitan mo na lang ng actual assets kung meron na
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              AnimatedMtApoBanner(imageAsset: _headerImage, title: 'Mt. Lingguhob'),
...
class _TrailActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colors = context.appColors;
    final buttonColor = context.isDarkMode ? colors.accent : MtLingguhobScreen._buttonColor;
