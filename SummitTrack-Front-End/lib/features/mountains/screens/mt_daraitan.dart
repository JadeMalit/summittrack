...
class MtDaraitanScreen extends StatelessWidget {
  const MtDaraitanScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final trailButtons = [
      _TrailButtonConfig(
        title: 'Summit Assault Trail',
        subtitle: 'Open Trail Details',
        onTap: () {
          Navigator.of(context).pushNamed('/mountain/daraitan/trail/summit');
        },
      ),
      _TrailButtonConfig(
        title: 'Tinipak River Circuit',
        subtitle: 'Open Trail Details',
        onTap: () {
          Navigator.of(context).pushNamed('/mountain/daraitan/trail/tinipak');
        },
      ),
      _TrailButtonConfig(
        ...
        subtitle: 'Open Trail Details',
        onTap: () {
          Navigator.of(context).pushNamed('/mountain/daraitan/trail/traverse');
        },
      ),
    ];
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              AnimatedMtApoBanner(imageAsset: _headerImage, title: 'Mt. Daraitan'),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const _InfoLine(label: 'Name:', value: 'Mt. Daraitan'),
                    const _InfoLine(
                      label: 'Location:',
                      value: 'Tanay, Rizal and General Nakar, Quezon, Philippines.',
                    ),
                    const _InfoLine(
                      label: 'Elevation:',
                      value: '739 meters above sea level. An eco-tourism gem in the heart of the Sierra Madre range.',
                    ),
                    const _InfoLine(
                      label: 'Description:',
                      value: 'Mt. Daraitan is a highly popular destination offering a raw adventure experience. It perfectly combines a grueling, steep forest trek with the refreshing beauty of pristine rivers, natural limestone pools, and dark rock caves.',
                    ),
                    const _InfoLine(
                      label: 'Slope:',
                      value: 'Sharply vertical and highly technical. Composed primarily of jagged karst/limestone rock walls, sharp edges, and continuous root networks requiring careful balancing and active upper body climbing.',
                    ),
...
class _TrailActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colors = context.appColors;
    final buttonColor = context.isDarkMode ? colors.accent : MtDaraitanScreen._buttonColor;
