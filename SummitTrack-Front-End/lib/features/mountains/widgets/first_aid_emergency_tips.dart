...
class _FirstAidEmergencyTipsState extends State<FirstAidEmergencyTips> {
  ...
  static const _tips = [
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/first_aid_kit.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/cuts_wounds.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/sprains.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/heat_exhaustion.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/heat_stroke.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/insect_bites.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/allergic_reaction.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/snake_bite.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/fainting.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/burns.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/hypothermia.png',
      body:
    ...
    _EmergencyTipItem(
      ...
      imagePath: 'assets/images/first_aid/hiking_reminders.png',
      body:
                    ...
                    if (item.imagePath != null) ...[
                      ClipRRect(
                        ...
                        child: Image.asset(
                          item.imagePath!,
                          width: double.infinity,
                          fit: BoxFit.fitWidth, // 👈 BUONG IMAGE NA ANG IPAPAKITA, WALANG BUCKET/CROP
